 ...
 * @LastEditTime: 2026-04-10 15:25:46
 * @
...
export default [
  {
    ...
    slider_percent: 0.5,
    desc: "智能识别人脸区域，一键去除模糊，增强面部细节，提升人脸图像的清晰度与质量",
    count: 23525,
    okExample: [
      {
        id: 1,
  ...
  },
  {
    ...
    desc: "对图像分辨率进行细节增强、图像修复以及倍数放大，显著提升图像细节丰富度，使图像变得更加清晰，具有更加真实、自然的细节。",
  ...
  },
  {
    ...
    desc: "对低质量的设计素材图像进行优化处理，用于后续的设计生产，对拍摄的照片进行清晰度提升。",
  ...
  },
  {
    ...
    desc: "分析黑白图片的内容，识别出不同的物体、人物、背景等元素，并为它们赋予相应的颜色，将其转换为彩色图片，使其更适合展示。",
  ...
  //   name: "人像微动",
  //   action: "animate",
  //   desc: "将静态图片中的人物变成动态化效果，让人物动作、面部表情鲜活起来，为友人祝福更生动。",
  //   isnew: true,
  //   ishidden: true,
