...
export default class ClassifyController extends Controller {
  async list(ctx) {
    ...
    const data = await this.service.admin.ai.classify.list(query);
    ctx.respond(data);
  }
  ...
  async findOne(ctx) {
    ...
    const data = await this.service.admin.ai.classify.findOne(id);
    ctx.respond(data);
  }
  ...
  async create(ctx) {
    ...
    const data = await this.service.admin.ai.classify.create(body);
  ...
  async update(ctx) {
    ...
    const data = await this.service.admin.ai.classify.update(body);
  ...
  async delete(ctx) {
    ...
    const data = await this.service.admin.ai.classify.delete(id);
