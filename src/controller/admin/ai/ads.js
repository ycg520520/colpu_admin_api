...
export default class AdsController extends Controller {
  async list(ctx) {
    ...
    const data = await this.service.admin.ai.ads.list(query);
    ctx.respond(data);
  }
  ...
  async findOne(ctx) {
    ...
    const data = await this.service.admin.ai.ads.findOne(id);
    ctx.respond(data);
  }
  ...
  async create(ctx) {
    ...
    const data = await this.service.admin.ai.ads.create(body);
  ...
  async update(ctx) {
    ...
    const data = await this.service.admin.ai.ads.update(body);
  ...
  async delete(ctx) {
    ...
    const data = await this.service.admin.ai.ads.delete(id);
    ctx.respond(data, data ? 0 : 1, data ? "已删除" : "操作失败");
  }

  async getSettings(ctx) {
    const data = await this.service.admin.ai.ads.getSettings();
    ctx.respond(data);
  }
  ...
  async updateSettings(ctx) {
    ...
    const data = await this.service.admin.ai.ads.updateSettings(body);
